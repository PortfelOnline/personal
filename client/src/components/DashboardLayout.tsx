...
import { BarChart2, BookOpen, Bot, Brain, Calendar, CandlestickChart, FileText, Globe, LogOut, PanelLeft, Server, Sparkles, TrendingUp, Users } from "lucide-react";
...
const menuItems = [
  ...
  { icon: TrendingUp, label: "SEO Tracker", path: "/seo-tracker" },
  ...
  { icon: Server, label: "DeepSeek", path: "/deepseek" },
